...
type MainBranch struct {
	...
	SubModulesCommitId []string `json:"sub_module_commit_id,omitempty"`
...
type Remote struct {
	...
	SubModulesNames []string       `json:"sub_module_names,omitempty"`
...
type RepositoryStatus struct {
	...
	SelectedSubModulesCommitId []string `json:"selected_sub_modules_commit_id"`
	...
	MainSubModulesCommitId       []string  `json:"main_sub_modules_commit_id"`
